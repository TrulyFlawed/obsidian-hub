...
- [[ai-knowledge-hub|AI Hub]]: AI assistant for your notes: text editing, vault audit and Dataview support. Works with OpenRouter, OpenAI, Groq or locally via Ollama.
...
- [[agentage-galaxy|Agentage Galaxy]]: A 3D, rotating force-graph of your vault: notes are nodes, links are edges. Fly through your knowledge graph from the toolbar. Part of Agentage Memory, the shared memory for every AI.
...
- [[agentic-chat|Agentic Chat]]: Privacy-first agentic AI chat in the sidebar. The agent reads, searches, and edits your vault through visible tool calls, routed to zero-data-retention providers by default, or runs fully local with Ollama.
...
- [[annotation-manager|Annotation Manager]]: Annotate text inline, view all annotations in a sidebar, and query annotations via Dataview.
...
- [[better-plugins-manager|Better Add-on Manager]]: Make plugin management more intuitive and efficient.
...
- [[book-progress|Book Progress]]: Read books with ease: scroll-position memory, remaining reading time, and book progress bars.
...
- [[calendar-hub|Calendar Hub]]: Find every note created on a given day from one calendar view, no matter which folder it lives in.
...
- [[canvas-bases|Canvas Bases]]: Canvas-style layouts and JSON Canvas materialization for Bases.
...
- [[checksorted|CheckSorted]]: Keep checkbox lists tidy: move completed items into a separate section, autocomplete tasks, and delete them in one click.
...
- [[cite-engine|Cite Engine]]: Drift-proof, closed-corpus citations via block refs. Cite only from your clipped sources — fabrication impossible by construction.
...
- [[cobrain|Cobrain]]: 懂你 vault 的创作副脑：把你写过的笔记当前知识喂给 AI，撞出旧念头、回抛问题——陪你想，不替你想.
...
- [[code-workbench|Code Workbench]]: Let Claude maintain your vault: link-preserving edits you approve, plus a real code editor with syntax highlighting, diagnostics, formatting, diffs, git review, and inline git blame for 50+ languages.
...
- [[bases-collapsing-group-table|Collapsing Group Table]]: A Bases table view whose groups collapse like a tree, with nested groups, inline editing, and tag/link autocomplete.
...
- [[command-group|Command Group]]: Group commands and select them quickly with custom keyboard shortcuts.
...
- [[claude-companion|Companion for Claude]]: Chat with Claude inside your vault, generate gallery-grade interactive planning artifacts, and sync everything Claude produces back into your notes.
...
- [[context-nine|Context Nine]]: TaskNotes capture, context routing, vault command cockpit, and attachment cleanup tools.
...
- [[contextual-ai-reader|Contextual AI Reader]]: Multilingual AI reading companion for translation, contextual vocabulary, PDFs, and Markdown notes.
...
- [[copy-for-email|Copy for Email]]: Copy selections or whole notes as email-ready rich text. Tables, callouts, code and Mermaid diagrams survive pasting into Gmail, Outlook and Apple Mail; chat apps get clean plain text.
...
- [[dbml-erd|DBML ER Diagrams]]: Renderiza bloques de código dbml como diagramas entidad-relación con ruteo ortogonal estilo dbdiagram.io.
...
- [[docx-exporter-plus|DOCX Exporter Plus]]: Export Markdown notes to DOCX with Word heading navigation, visible colors on white paper, and working links.
...
- [[dainvo-task-manager|Dainvo Task Manager]]: Sync vault tasks with Dainvo using a local desktop bridge.
...
- [[dangling-image-manager|Dangling Image Manager]]: Find and delete dangling imagages with a simple ui.
...
- [[date-list|Date List]]: Returns a list of dates according to the conditions you supply.
...
- [[day-planner-enhanced|Day Planner Enhanced]]: A day planner with an enhanced timeline UI and readable nested schedules. Based on Day Planner 0.30.0.
...
- [[desmos-live|Desmos Live]]: Embed live interactive Desmos graphs using desmos-live code blocks.
...
- [[dgmo|Diagrammo Diagrams]]: Render diagrams inline from plain-text dgmo code blocks. 40+ chart types — flowcharts, sequence, gantt, charts, mind maps, and more — with live preview, themed palettes, and mobile support.
...
- [[docferry|DocFerry]]: Publish one note to a secure DocFerry share link.
...
- [[echo-notes|Echo Notes]]: Turn audio files in your vault into linked Markdown transcripts.
- [[echo-recall|Echo Recall]]: 3-step progressive text memorization and spaced repetition.
...
- [[filamental|Filamental]]: View your project vault in 3D using Filamental. Both apps use the same markdown files, so your notes stay in sync automatically. Free forever for one project — Pro for professional and commercial use.
...
- [[gtd-flow|GTD Flow]]: Structured GTD: sequential/parallel projects, defer dates, next actions, forecast and review.
...
- [[galaxy-view|Galaxy View]]: Cinematic 3D graph view of your vault — fly through your notes like NASA Eyes.
...
- [[german-law-lookup|German Law Lookup]]: Look up German federal law references and insert formatted law text into notes.
...
- [[glasp|Glasp]]: Import your Glasp web and Kindle highlights and notes into your vault.
...
- [[glossa|Glossa]]: AI sidebar with multi-provider chat, @-context, semantic search (RAG), agent mode with sandboxed file edits, MCP bridge, encrypted keys, and Codex CLI integration.
...
- [[hanmark|HanMark]]: Import HWP, HWPX, PDF, DOCX and XLSX files into your notes as Markdown, and convert notes back to HWP, DOCX and HTML through templates.
...
- [[handwriting-latex|Handwriting and Image to LaTeX]]: Draw math formulas by hand or import from album, then convert them to LaTeX using AI APIs (SimpleTex / Custom).
...
- [[harmony|Harmony]]: One task, multiple perspectives. The ultimate modular workspace. Instantly sync your data across Todo lists, Calendars, and Kanban views.
...
- [[heading-mindmap|Heading Mindmap]]: Open Markdown headings as editable mind maps and edit section content in a bottom pane.
...
- [[heading-shift|Heading Shift]]: Promote or demote heading levels together with all sub-headings at once, like Typora.
...
- [[image-peek|Image Peek]]: Quick Look–style image preview. Click an image or press Space to peek, like Finder and Freeform.
...
- [[inkclaw-sync|InkClaw Sync]]: Sync notes you forwarded to InkClaw (auto-transcribed and polished) into your vault, with media attachments. Works on desktop and mobile.
...
- [[insert-path|Insert Path]]: Fuzzy-find any file or directory under a root and insert its path at the cursor.
...
- [[interlinear|Interlinear]]: Translate notes paragraph by paragraph in reading view — bilingual or translation-only alongside the original, without ever modifying your files. BYOK (DeepSeek or any OpenAI-compatible endpoint).
...
- [[issuetracker|IssueTracker]]: Sync GitCode issues, classifications, and daily reports into your vault.
...
- [[jotdrop|JotDrop]]: A private, offline Google Keep alternative for your vault: a Google Keep–style quick-capture card grid, paired with a companion Android app (share-sheet, OCR, voice) and a Chrome web clipper. No account, no cloud, every note plain Markdown.
...
- [[keyword-notes-editor|Keyword Notes Editor]]: View and edit notes grouped by keyword tags, similar to Logseq tag view.
...
- [[lecture-lens|Lecture Lens]]: AI course assistant: PDF/slides → Markdown notes, OCR, LLM chat with @ notes & local RAG (DeepSeek/Kimi). 课件PDF转笔记、识图OCR、大模型聊天与课程检索。
...
- [[lemma-flashcards|Lemma]]: Create and review flashcards with spaced repetition using the FSRS algorithm. Supports cloze deletions, custom study sessions, statistics, and CouchDB sync.
...
- [[library|Library]]: Organize movies, series, and other media as visual cards with automatic metadata from OMDb.
...
- [[lifequest|LifeQuest]]: Gamify your daily life with quests, XP, levels, streaks, and a personal dashboard.
...
- [[link-plus|Link Plus]]: Build a connected second brain. Find every unlinked mention in your vault and convert them to wikilinks — one click or batch. Grow your knowledge graph automatically, zero setup.
...
- [[autolink-keywords|Linkosaurus]]: Automatically links keywords to notes and turns URLs into Markdown links as you type, paste, or dictate.
...
- [[live-image-editor|Live Image Editor]]: Edit images non-destructively: crop, rotate, flip, resize, and apply CSS filters live, without modifying the original file.
...
- [[logography|Logography]]: Analyze dreams and explore personal beliefs through guided Socratic dialogue. Sessions stay in your vault as Markdown.
...
- [[lorebase|Lorebase]]: Track games and anime with card views, status filters, ratings, and metadata integrations.
...
- [[lumina|Lumina]]: Language-Agnostic RAG & MCP Agent powered by Multilingual Embeddings for local AI semantic search.
...
- [[markway|Markway]]: Sync Apple Journal entries with your vault.
...
- [[math-chords|Math Chords]]: Type LaTeX math with keyboard shortcuts—fractions, Greek letters, integrals, and 100+ snippets (leader key + keys). Inline preview, display-math wrap. Settings UI in 70+ languages incl. Chinese.
...
- [[meetings-plus|Meetings Plus]]: Subscribe to calendars and create pre-filled meeting notes in one click. No drag-and-drop, no Outlook required. ICS-based, privacy-first.
...
- [[mobile-pdf-exporter|Mobile PDF Exporter]]: One-click selectable preview PDF export for mobile and desktop.
...
- [[myworld-task-manager|MyWorld Task Manager]]: Manages daily routines, task scheduling, and project sync with bi-directional task updates.
...
- [[plugin-name-locker|Name Locker]]: Lock custom display names for your installed plugins so they persist through updates.
...
- [[nldates-chinese|Natural Language Dates - Chinese]]: 支持中文自然语言输入日期，如 @今天、@下周三、@3天后.
...
- [[notedraw|NoteDraw]]: Draw and edit directly on notes.
...
- [[notes-exporter|Notes Exporter]]: Decorate exported Apple Notes and Bear Notes with native app icons. Open notes in their source app.
...
- [[o-tie|O-Tie]]: Build and edit risk bowtie diagrams in a visual editor with barriers, escalation factors, analysis stacks, and PNG export.
...
- [[okf-enforcer|OKF Enforcer]]: Validate and enforce the Open Knowledge Format (OKF v0.1): required type frontmatter, index.md/log.md structure, quick-fixes, on-save checks, and a vault-wide report.
...
- [[word-reader|Office Reader]]: Open .docx and .pptx files as safe, read-only documents.
...
- [[orbit-graph-view|Orbit]]: Visualize your notes as a recursive planetary system. Orbit child notes around their parents using frontmatter, tags, outlinks, or backlinks with smooth, premium physics.
...
- [[local-pdf-annotator|PDF Annotator]]: Read PDFs, highlight passages, place page notes, and manage searchable margin annotations stored as local Markdown sidecars.
- [[pdf-commenter|PDF Commenter]]: A PDF viewer with an annotation system backed by markdown notes. Select text, create comments with backlinks, and keep everything inside your vault.
...
- [[react-kanban|React Kanban]]: Render markdown-backed Kanban boards with a React UI.
...
- [[readwise-reading-tracker|Readwise Reading Tracker]]: Track Readwise reading progress and use highlights in a Zettelkasten workflow with quick note review, inbox capture, and source links.
- [[real-chat|Real Chat]]: Chat sidebar for any OpenAI-compatible API (DeepSeek, OpenRouter and more). Bring your own key. Reads and edits your notes, ranked vault search, web access, image tools, and persistent memory.
- [[real-pin|Real Pin]]: Confirms before closing a pinned tab via any close hotkey or command, so a stray Cmd+W can't lose your pinned tab.
...
- [[regex-replace|Regex Replace]]: Find and replace text using regular expressions with real-time preview, match highlighting, and reusable multi-step pipeline rulesets.
...
- [[right-click-tools|Right-Click Tools]]: Adds Explorer right-click actions and a ribbon button to create today's date folder or note from a configurable template and move selected items to a configurable folder.
...
- [[rootweave|Rootweave]]: A conlang workspace for worldbuilders — manage roots, build words, validate grammar, and translate.
...
- [[sane-smart-ai-note-evolution|SANE - Smart AI Note Evolution]]: Evolve your notes intelligently with AI. When you add/edit notes, SANE finds the 3 most relevant notes and enhances them with smart tags, keywords, links, and summaries.
...
- [[sage|Sage]]: Generate linked concept notes from selected text in your vault.
...
- [[save-history|Save History]]: Saves and restores versions of markdown files.
...
- [[scoped-snippets|Scoped Snippets]]: Choose a CSS snippet per .base or .md file, and apply it only to that Base or Markdown view.
...
- [[screenshot-selection|Screenshot Selection]]: Capture selected note content as a PNG. Copies to clipboard when possible, with a vault file fallback on mobile.
...
- [[section-meter|Section Meter]]: Shows configurable section stats beside each heading and the note title in the editor.
...
- [[semantic-vault-mcp|Semantic Notes Vault MCP]]: Give Claude Desktop and other AI assistants semantic access to your notes through a built-in Model Context Protocol (MCP) server.
- [[bbawj-semantic-search|Semantic Search]]: Semantic search for files using text embeddings
- [[semantic-todoist-sync|Semantic Todoist Sync]]: BYOK semantic vault search, Gemini/OpenAI-assisted task extraction, email-to-Todoist, and note-to-Todoist sync.
...
- [[smart-review|Smart Review]]: Review center for Properties and YAML frontmatter with spaced feedback, history, and AI payload export.
...
- [[smart-table|Smart Table]]: Interactive tables in your notes: typed columns, sorting, filtering, status pills, and add or remove columns and rows.
...
- [[spotify-control|Spotify Control]]: Control Spotify from your notes. Now-playing sidebar with hover controls, time-synced lyrics via LRCLIB, queue, search, transport hotkeys, and insert-track-into-note. Display works on Free; playback control requires Premium.
...
- [[squire|Squire]]: Your faithful note-taking companion. Automates file title naming, and finds related notes so you can stay in the flow.
...
- [[regex-css-highlighter|SwiftGloss]]: Regex matching + CSS highlighting with real-time preview and instant effects. (formerly Regex Css Highlighter)
...
- [[table-calc|Table Calc]]: Adds formula support to markdown tables. Use =SUM(A1:A5), =AVG(B1:B3), =A1*B1, etc. in any table cell.
...
- [[tag-lens|Tag Lens]]: Visualize tag–note relationships in your Obsidian Bases vault. Explore multi-way overlaps with a co-occurrence heatmap, intersection lattice, and BubbleSets; dive into individual notes with the Icon Gallery.
...
- [[tandem-comments|Tandem Comments]]: Google Docs-style comments for Markdown notes. Quote-anchored threads in a fenced block at the end of the file, so your prose stays untouched and AI assistants can read and write them too.
...
- [[task-hub|Task Hub]]: Manage vault, Apple Reminders, Apple Calendar, and Dida/TickTick tasks in one workspace.
...
- [[tasknotes-workflows|TaskNotes Workflows]]: Markdown-defined workflow automation for TaskNotes.
...
- [[theme-plume|Theme Plume]]: Render VuePress Theme Plume markdown containers, including file-tree, tabs, steps, cards, and more.
...
- [[thoth-sync|Thoth]]: Lightweight vault sync via S3-compatible object storage.
...
- [[thought-synapse-desktop|Thought Synapse (Desktop)]]: A 3D interactive knowledge topology graph and word cloud engine optimized for desktop devices.
...
- [[trietment-kanban|Trietment Kanban]]: Collect tasks from across your vault as draggable Kanban cards — with due dates and times, projects, priorities, subtasks, recurring tasks, a month/week/day calendar view and optional Outlook calendar sync.
...
- [[tufte-chart|Tufte Chart]]: Render `chart` code blocks as Tufte-style ASCII charts.
...
- [[ultra-search|UltraSearch]]: Fuzzy, out-of-order, and typo-tolerant search across file names and line contents with color-coded navigation across all Markdown files in the vault.
...
- [[understory|Understory]]: Local-first knowledge layer for relationship discovery, ER facts, graph analysis, and optional model-powered insights.
...
- [[vault-file-refresh|Vault File Refresh]]: Recursively polls for new files added to the vault from external sources and reconciles them automatically. Fixes missing file explorer refresh on Flatpak, network drives, and sync tools.
...
- [[vector-ink|VectorInk]]: Create handwritten notes as vector graphics. Each stroke is saved as a Bézier curve, with customizable background and pen colors for infinite scalability.
- [[vectrola-sync|Vectrola Sync]]: Sync your Vectrola music wiki with Google Drive. Pull/push wiki files across devices.
...
- [[verdant|Verdant]]: One-click publish your notes as a beautiful website.
- [[verilog-bitfield|Verilog Bitfield]]: Render Verilog bitfield definitions as interactive SVG diagrams and tables.
...
- [[voice|Voice]]: Listen to your notes as natural speech with text-to-speech (TTS). Read notes aloud, play them like an audiobook in the voice player, download MP3 audio and listen offline hands-free on mobile.
...
- [[weave-incremental-reading|Weave Incremental Reading]]: Standalone incremental reading workflow with topics, reading points, calendar scheduling, and source tracing.
...
- [[web-novel-assistant|WebNovel Assistant]]: A comprehensive plugin for web novel writers. Track word counts, goals, and focus time. Manage foreshadowing, timelines, and timed tasks. Includes a bilingual UI and OBS overlay.
...
- [[wechat-converter|Wechat Converter]]: Convert Markdown into polished WeChat articles, Feishu cloud docs, and multi-platform publishing drafts.
...
- [[workspace-clock|Workspace Clock]]: A clock + dropdown stopwatch and calendar that lives in the workspace tab.
...
- [[ytkn|YT Knowledge Notes]]: Turn YouTube videos and playlists into structured knowledge notes in your vault.
...
- [[feishu-doc-toolbar|ZengQiang Enhanced]]: 浮动工具栏、模板库、内置原生表格配色/长宽高与多种实用工具，无需再装表格插件。含 Claudian 跨设备续聊、粘贴触发文件本地化、OneNote 原生表格粘贴等.
...
- [[arxiv-daily|arXiv Daily]]: Daily arXiv tracker that filters and summarizes papers via LLM into your vault.
...
- [[drive-nine|drive9]]: Sync your vault across devices via drive9 with semantic search and AI-agent access.
...
- [[lilbee|lilbee]]: A local AI search engine and native LLM manager for your vault, with a built-in web crawler. Ask it anything and get cited answers (local RAG). Works with Ollama, LM Studio, and frontier models too.
...
- [[mv-obcc|mv-SenceAI]]: Connects local vaults to Claude Code with page tracking, session-aware terminals, MCP tools, editable diffs, and optional upstream compatibility.
