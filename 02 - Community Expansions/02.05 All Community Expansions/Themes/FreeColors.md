...
![Downloads](https://img.shields.io/badge/downloads-273-573E7A?style=for-the-badge&logo=)
![GitHub last commit](https://img.shields.io/github/last-commit/erulmu/freecolors?color=573E7A&label=last%20update&logo=github&style=for-the-badge)
![GitHub issues by-label](https://img.shields.io/github/issues/erulmu/freecolors/help%20wanted?color=573E7A&logo=github&style=for-the-badge) 
![GitHub Repo stars](https://img.shields.io/github/stars/erulmu/freecolors?color=573E7A&logo=github&style=for-the-badge)
...
Repository: [GitHub](https://github.com/erulmu/freecolors)
Designed by: [[erulmu]]
Modes: [[Light-mode themes|light]], [[Dark-mode themes|dark]]



![screenshot](https://github.com/erulmu/freecolors/raw/HEAD/screenshot.png)

%% ----- Do not edit anything above this line ----- %% 

%% Does the repository or author have any sponsoring links? Uncomment the next line and add them to the author's note. If they don't, please delete the placeholder tag: #placeholder/author %%
%% ![[erulmu#Sponsor this author]] %%
...
**🎨 FreeColors Setup & Simulator**: SIMULATOR: [ https://erulmu.github.io/freecolors/ ] 

Open this link in your browser to design your palette. Download the JSON, then use the 'Import' button at the top right of this panel to apply your theme.
- 🌈 Enable Rainbow Folders: Turns on the hierarchical folder coloring (Colors are managed via the Simulator).
...
**Ribbon**: 
- Ribbon style: Display options for ribbon menu. Ribbon must be turned on in Obsidian Appearance settings for these options to work.
...
- Center small tables: Make small tables centered
...
- Markdown syntax color: Markdown formatting syntax text color
- Italic text color
- Bold text color
- Bold text weight
...
- Folder 1 - Main Color
- Folder 1 - Icon Color
- Folder 1 - Muted Background
- Folder 2 - Main Color
- Folder 2 - Icon Color
- Folder 2 - Muted Background
- Folder 3 - Main Color
- Folder 3 - Icon Color
- Folder 3 - Muted Background
- Folder 4 - Main Color
- Folder 4 - Icon Color
- Folder 4 - Muted Background
- Folder 5 - Main Color
- Folder 5 - Icon Color
- Folder 5 - Muted Background
- Folder 6 - Main Color
- Folder 6 - Icon Color
- Folder 6 - Muted Background
- Folder 7 - Main Color
- Folder 7 - Icon Color
- Folder 7 - Muted Background
- Folder 8 - Main Color
- Folder 8 - Icon Color
- Folder 8 - Muted Background
- Folder 9 - Main Color
- Folder 9 - Icon Color
- Folder 9 - Muted Background
- Folder 10 - Main Color
- Folder 10 - Icon Color
- Folder 10 - Muted Background
...
<span class="git-footer">[Edit In GitHub](https://github.dev/obsidian-community/obsidian-hub/blob/main/02%20-%20Community%20Expansions/02.05%20All%20Community%20Expansions/Themes/FreeColors.md "git-hub-edit-note") | [Copy this note](https://raw.githubusercontent.com/obsidian-community/obsidian-hub/main/02%20-%20Community%20Expansions/02.05%20All%20Community%20Expansions/Themes/FreeColors.md "git-hub-copy-note") | [Download this vault](https://github.com/obsidian-community/obsidian-hub/archive/refs/heads/main.zip "git-hub-download-vault") </span>
