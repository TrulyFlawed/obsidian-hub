...
![Downloads](https://img.shields.io/badge/downloads-84027-573E7A?style=for-the-badge&logo=)
...
- **Tab stacks**: 
    ...
    - Spine element order
- **Sidebars**: 
    - Disable text labels for primary navigation: Turns off text labels on navigation items in the left sidebar
