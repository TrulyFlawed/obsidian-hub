...
- 헤더 디자인 템플릿: H1-H4 디자인을 Live Preview와 PDF 출력에 함께 적용합니다.
- 드롭 캡 (첫 문단 첫 글자 크게)
- 간격 프리셋
- 액센트 컬러 프리셋
- 코드블록 테마
...
**폰트 적용**: 
- 인터페이스 폰트 직접 입력: 비워두면 Obsidian 외형 설정의 인터페이스 폰트를 따릅니다. 예시는 "Malgun Gothic", Pretendard, sans-serif 입니다.
- 본문 폰트 직접 입력: 비워두면 Obsidian 외형 설정의 텍스트 폰트를 따릅니다. 예시는 "Noto Serif KR", serif 입니다.
- 코드 폰트 직접 입력: 비워두면 Obsidian 외형 설정의 모노스페이스 폰트를 따릅니다. 예시는 "D2Coding", "JetBrains Mono", monospace 입니다.
- 하단 상태바 폰트 직접 입력: 비워두면 인터페이스 폰트를 따릅니다. 예시는 "Malgun Gothic", sans-serif 입니다.
